...
interface CrossdockingZonaCeldaFormulaEditorProps {
  formula: string;
...
export default function CrossdockingZonaCeldaFormulaEditor({ formula, varMap, onSave, onCancel, position, systemVarDefs, systemVarMap }: CrossdockingZonaCeldaFormulaEditorProps) {
