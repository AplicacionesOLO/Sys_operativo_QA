...
export interface CostoCrossdockingColumna {
  id: string;
  nombre: string;
  tipo: ColumnType;
  opciones: string[];
...
export interface CostoCrossdockingFila {
  id: string;
  proceso: string;
  subproceso: string;
...
export interface CrossdockingZonaColumnaDinamica {
  id: string;
  zona: string;
  nombre: string;
  tipo: string;
...
export interface CrossdockingZonaCeldaFormula {
  id: string;
  columna_id: string;
  articulo: string;
  id_compania?: string;
...
export interface CrossdockingArticuloResumenRow {
  articulo: string;
  descripcion: string;
  movimientos: number;
  unidades: number;
...
export interface CrossdockingZonaResumenRow {
  zona: string;
  movimientos: number;
  unidades: number;
...
export interface CrossdockingZonaArticuloDetalleRow {
  zona: string;
  articulo: string;
  descripcion: string;
  movimientos: number;
...
export interface CrossdockingZonaArticuloCompaniaRow {
  zona: string;
  idCompania: string;
  articulo: string;
  descripcion: string;
...
export interface CrossdockingZonaArticuloMensualRow {
  zona: string;
  idCompania: string;
  articulo: string;
  descripcion: string;
...
export interface CrossdockingResumenCompleto {
  articulos: CrossdockingArticuloResumenRow[];
  zonas: CrossdockingZonaResumenRow[];
  zonaArticulos: CrossdockingZonaArticuloDetalleRow[];
  totalRows: number;
